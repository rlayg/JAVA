//package ch12;
//
//class Account2Userprac extends Thread {
//	
//	Account2 account2;
////	String name;
///*
...
//				if(account2.flag)  account2.deposit((int)(Math.random()*10000), getName());
//				else account2.withdraw((int)(Math.random()*10000), getName());
//				account2.flag = !account2.flag; //flag Swap //flag의 boolean값을 반대로 바꾸는거 
//			}
//		}
//	}
//}
//
//public class Account2Exprac {
//
